...
## Why
MessageVault 组织下的 3 个仓库（.github、MessageVault-Mobile、SMS-Previewer）目前分散在独立仓库中，维护成本高、协作不便。将它们合并到当前工作区作为 Monorepo，可以统一管理、简化 CI/CD 流程，并集中处理组织级文档和许可证。
