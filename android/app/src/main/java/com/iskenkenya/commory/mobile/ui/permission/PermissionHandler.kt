package com.iskenkenya.commory.mobile.ui.permission
...
class PermissionHandler(private val activity: ComponentActivity) {
    ...
    private val requestPermissionLauncher = activity.registerForActivityResult(
        ...
        if (allGranted) {
            ...
            Toast.makeText(activity, activity.getString(com.iskenkenya.commory.mobile.R.string.permissions_granted_toast), Toast.LENGTH_SHORT).show()
        } else {
            ...
            if (deniedPermissions.any { activity.shouldShowRequestPermissionRationale(it) }) {
                ...
                Toast.makeText(activity, activity.getString(com.iskenkenya.commory.mobile.R.string.permissions_settings_toast), Toast.LENGTH_LONG).show()
            }
        }
    }
    ...
    private fun showPermissionRationaleDialog() {
        Toast.makeText(activity, activity.getString(com.iskenkenya.commory.mobile.R.string.permission_rationale), Toast.LENGTH_LONG).show()
    }
}
